    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('adminrole.index')" :active="request()->routeIs('adminrole.index')">Roles
                </x-admin-link>
                <x-admin-link :href="route('adminpermission.index')"
                    :active="request()->routeIs('adminpermission.index')">Permission</x-admin-link>
                <x-admin-link :href="route('adminuser.index')" :active="request()->routeIs('adminuser.index')">User
                </x-admin-link>
