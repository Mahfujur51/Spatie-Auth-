        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100">
                    ...
                    <a href="{{ route('adminrole.create') }}" class="px-4 py-2 bg-green-600 hover:bg-green-400 rounded-md text-white">Create Role</a>
                </div>
                </header>
                <div class="p-3">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex justify-end">
                                            <div class=" flex space-x-2">
                                                <a href="{{ route('adminrole.edit',$role->id) }}" class="px-4 py-1 bg-blue-500 hover:bg-blue-700 text-white rounded-md">Edit</a>
                                                <form action="{{ route('adminrole.destroy',$role->id) }}" method="Post" onsubmit="return confirm('Are you Sure to Delete');">
